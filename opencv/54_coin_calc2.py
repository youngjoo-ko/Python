...
circles = cv2.HoughCircles(blur, cv2.HOUGH_GRADIENT, 1, 30, param1=250, param2=40, minRadius=15, maxRadius=200)
print(circles[0][0].shape) # 검출된 원의 (x , y 좌표, 반지름)을 가진 배열을 리턴한다 
